...
// Helper extension to convert Color to and from hex string
extension Color {
...
// Updated SettingsView with ColorPicker
struct SettingsView: View {
    ...
    var body: some View {
        ...
        .onChange(of: selectedColor) { _, newColor in
            accentColorHex = newColor.hexString // Save the selected color as a hex string
        }
        .onAppear {
            selectedColor = Color(hex: accentColorHex) // Load the saved color
        }
    }
}
